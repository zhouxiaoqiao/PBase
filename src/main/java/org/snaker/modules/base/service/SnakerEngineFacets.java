...
public class SnakerEngineFacets {
	...
	public void initFlows() {
		engine.process().deploy(StreamHelper.getStreamFromClasspath("org/snaker/flows/actorall.snaker"));
		engine.process().deploy(StreamHelper.getStreamFromClasspath("org/snaker/flows/group.snaker"));
		engine.process().deploy(StreamHelper.getStreamFromClasspath("org/snaker/flows/leave.snaker"));
		engine.process().deploy(StreamHelper.getStreamFromClasspath("org/snaker/flows/forkjoin.snaker"));
		engine.process().deploy(StreamHelper.getStreamFromClasspath("org/snaker/flows/custom.snaker"));
		engine.process().deploy(StreamHelper.getStreamFromClasspath("org/snaker/flows/free.snaker"));
	}
